...
const rareObject = ['basic', 'rare', 'epic', 'legendary']
...
export default ({
	...
	if (isRotated) {
		return (
			<div style={style} className={styles.card} onClick={onClick}>
				<span className='loader'></span>
				<div className={styles.content}>
					<div className={`${styles.back} ${styles[rareObject[rare]]}`}>
						<div className={styles.back_content}>
							<div className={styles.front}>
								...
								>
									...
									<g>
										<path
											d='M394.445,294.244c0.016,0,0.024,0,0.033-0.008c5.382-0.819,10.186-3.366,13.841-7.02
		...
		c-1.728,1.728-4.01,2.927-6.598,3.25C391.575,280.85,391.079,280.866,390.575,280.866z'
										/>
										<path
											d='M465.368,60.266C463.417,37.612,454.942,17.033,441.854,0c-5.713,50.41-44.614,92.677-96.91,104.344
		c15.238,17.056,35.156,43.159,48.294,74.677C439.522,158.16,469.8,111.52,465.368,60.266z'
										/>
										<path
											d='M167.049,104.344C114.761,92.685,75.852,50.41,70.147,0C57.05,17.033,48.584,37.612,46.632,60.266
				...
				<div className={`${styles.back} ${styles[rareObject[rare]]}`}>
					<div className={styles.back_content}>
						...
						<div className={styles.card_header}>
							<small className={styles.badge}>{title}</small>
						</div>
